...
function addShortcutElement(shortcut, index) {
    ...
    shortcutElement.innerHTML = `
        <img src="https://www.google.com/s2/favicons?domain=${shortcut.url}&sz=256" alt="${shortcut.name}" class="shortcut-img">
    ...
    const imgElement = shortcutElement.querySelector('.shortcut-img');
